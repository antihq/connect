...
<div class="mx-auto mt-10 max-w-2xl rounded bg-white p-6 shadow">
    <h1 class="mb-4 text-2xl font-bold">Transaction #{{ $transaction->id }}</h1>
    ...
    <div class="mb-2 text-gray-700">
        ...
        <span>${{ number_format($transaction->total / 100, 2) }}</span>
    </div>
    <div class="mb-2 text-gray-700">
    ...
    <div class="mb-2 text-gray-700">
        ...
        <span>
            @if ($transaction->listing)
                <a
                    href="{{ route('backstage.listings.show', $transaction->listing) }}"
    ...
    <div class="mt-6 flex items-center gap-4">
        <a href="{{ route('backstage.transactions.index') }}" class="text-blue-600 hover:underline">
