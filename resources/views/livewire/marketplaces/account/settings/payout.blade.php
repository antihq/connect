...
@if($accountType !== '')
    <div class="text-xs text-zinc-500 mt-1">Account type cannot be changed after it is set.</div>
@endif
...
@if($country !== '')
    <div class="text-xs text-zinc-500 mt-1">Country cannot be changed after it is set.</div>
@endif
